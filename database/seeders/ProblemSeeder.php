...
class ProblemSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $problem1->problem_status_id = ProblemStatus::where('problem_status_process', 'ปัญหาได้รับการแก้ไขแล้ว')->first()->id;
        $problem1->save();

        $problem2 = new Problem();
        $problem2->problem_description = 'ไฟกระพริบ delay นาน';
        $problem2->order_id = Order::find(1)->id;
        $problem2->problem_status_id = ProblemStatus::where('problem_status_process', 'ปัญหาได้รับการแก้ไขแล้ว')->first()->id;
        $problem2->save();
    }
}
